...
function csv2array(data, delimeter) {
  ...
  while (c != eof) {
    ...
    if (c == '\"') {
      ...
      if (c == eof) {
        throw "Unexpected end of data, double-quote expected" + " at column " + col + " and row " + row + " with last value = " + value;
      }
    ...
    if (c == delimeter) {
      ...
      throw "Delimiter expected after character " + i + " at column " + col + " and row " + row + " with last value = " + value;
    }
